...
export const twitterService = {
  ...
  getAdminAccounts: async (adminId) => {
    try {
      const response = await api.get(`/twitter/accounts/admin/${adminId}`);
      return response.data;
    } catch (error) {
      throw error.response?.data || error.message;
    }
...
export const discordService = {
  ...
  getAdminAccounts: async (adminId) => {
    try {
      const response = await api.get(`/discord/accounts/admin/${adminId}`);
      return response.data;
    } catch (error) {
      throw error.response?.data || error.message;
    }
...
export const telegramService = {
  ...
  getAdminAccounts: async (adminId) => {
    try {
      const response = await api.get(`/telegram/accounts/admin/${adminId}`);
      return response.data;
    } catch (error) {
      throw error.response?.data || error.message;
    }
